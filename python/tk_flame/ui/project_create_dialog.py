...
"}")
    ...
    def retranslateUi(self, ProjectCreateDialog):
        ProjectCreateDialog.setWindowTitle(QCoreApplication.translate("ProjectCreateDialog", u"Submit to Shotgun", None))
        self.label_9.setText("")
        self.label_5.setText(QCoreApplication.translate("ProjectCreateDialog", u"<b>Project Name</b>", None))
#if QT_CONFIG(tooltip)
        self.project_name.setToolTip(QCoreApplication.translate("ProjectCreateDialog", u"The <b>Flame project name</b> is automatically generated based on your current Shotgun project. ", None))
...
#if QT_CONFIG(tooltip)
        self.user_name.setToolTip(QCoreApplication.translate("ProjectCreateDialog", u"The <b>User Name</b> associated with your new Flame Project is based on the Shotgun user that matches your current login name.\n"
"", None))
#endif // QT_CONFIG(tooltip)
