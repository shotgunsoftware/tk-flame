...
"}")
        ...
        self.frame_rate = QtGui.QComboBox(self.tab_2)
        ...
        self.depth.addItem("")
        self.depth.addItem("")
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.FieldRole, self.depth)
        ...
        self.field_dominance.addItem("")
        self.field_dominance.addItem("")
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.FieldRole, self.field_dominance)
    ...
    def retranslateUi(self, ProjectCreateDialog):
        ...
        self.label_4.setText(QtGui.QApplication.translate("ProjectCreateDialog", "Frame Rate", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.frame_rate.setItemText(0, QtGui.QApplication.translate("ProjectCreateDialog", "23.976", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(1, QtGui.QApplication.translate("ProjectCreateDialog", "24", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(2, QtGui.QApplication.translate("ProjectCreateDialog", "25", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(3, QtGui.QApplication.translate("ProjectCreateDialog", "29.97 df", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(4, QtGui.QApplication.translate("ProjectCreateDialog", "29.97 ndf", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(5, QtGui.QApplication.translate("ProjectCreateDialog", "30", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(6, QtGui.QApplication.translate("ProjectCreateDialog", "50", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(7, QtGui.QApplication.translate("ProjectCreateDialog", "50.94 df", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(8, QtGui.QApplication.translate("ProjectCreateDialog", "50.94 ndf", None, QtGui.QApplication.UnicodeUTF8))
        self.frame_rate.setItemText(9, QtGui.QApplication.translate("ProjectCreateDialog", "60", None, QtGui.QApplication.UnicodeUTF8))
