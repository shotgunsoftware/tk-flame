...
class Ui_ProjectCreateDialog(object):
    def setupUi(self, ProjectCreateDialog):
        ...
        ProjectCreateDialog.resize(446, 503)
...
"}")
        ...
        self.proxy_width = QtGui.QSpinBox(self.old_proxy_tab)
        self.proxy_width.setMaximum(65536)
        self.proxy_width.setSingleStep(16)
        self.proxy_width.setObjectName("proxy_width")
        self.horizontalLayout_6.addWidget(self.proxy_width)
        self.proxy_width_label = QtGui.QLabel(self.old_proxy_tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.proxy_width_label.sizePolicy().hasHeightForWidth())
        self.proxy_width_label.setSizePolicy(sizePolicy)
        self.proxy_width_label.setObjectName("proxy_width_label")
        self.horizontalLayout_6.addWidget(self.proxy_width_label)
        ...
        self.proxy_min_width = QtGui.QSpinBox(self.old_proxy_tab)
        self.proxy_min_width.setMaximum(65536)
        self.proxy_min_width.setSingleStep(16)
        self.proxy_min_width.setObjectName("proxy_min_width")
        self.horizontalLayout_7.addWidget(self.proxy_min_width)
        self.proxy_min_width_label = QtGui.QLabel(self.old_proxy_tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.proxy_min_width_label.sizePolicy().hasHeightForWidth())
        self.proxy_min_width_label.setSizePolicy(sizePolicy)
        self.proxy_min_width_label.setObjectName("proxy_min_width_label")
        self.horizontalLayout_7.addWidget(self.proxy_min_width_label)
...
"", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.proxy_width_label.setText(QtGui.QApplication.translate("ProjectCreateDialog", "px", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.proxy_min_width_label.setText(QtGui.QApplication.translate("ProjectCreateDialog", "px", None, QtGui.QApplication.UnicodeUTF8))
