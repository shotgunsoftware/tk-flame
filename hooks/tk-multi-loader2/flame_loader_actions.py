...
class FlameLoaderActions(HookBaseClass):
    ...
    def _import_batch_file(self, sg_publish_data):
        ...
        :param dict sg_publish_data: Flow Production Tracking data dictionary with all the standard publish fields.
        """
    ...
    def _add_batch_group_from_shot(self, sg_publish_data, build_new):
        ...
        if sg_info is None:
            raise FlameLoaderActionError(
                "Cannot load a Batch Group from Flow Production Tracking using this Shot"
            )
    ...
    def _get_info_from_published_files(self, sg_published_files):
        ...
        :param [dict] sg_published_files: A list of Flow Production Tracking data dictionary with all the
    ...
    def _get_batch_path_from_published_files(self, sg_info):
        ...
        :param dict sg_info: A list of Flow Production Tracking data dictionary containing the published files.
    ...
    def _get_batch_info_from_sg_publish_data(self, sg_publish_data):
        """
        Gets the publish Batch file dictionnary from Flow Production Tracking data dictionnary

        :param sg_publish_data: Flow Production Tracking data dictionary with all the standard publish fields.
        :returns: A list of Flow Production Tracking data dictionary containing the published batch files.
        """
    ...
    def _get_batch_path_from_sg_publish_data(self, sg_publish_data):
        """
        Gets the current shot batch filefrom Flow Production Tracking data dictionnary
    ...
    def _build_path_from_template(template, fields):
        ...
        :param dict fields: Dictionary containing Flow Production Tracking Template keys and theirs values
