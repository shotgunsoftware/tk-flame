...
class Ui_ProjectCreateDialog(object):
    def setupUi(self, ProjectCreateDialog):
        ...
        ProjectCreateDialog.resize(401, 496)
...
"}")
        ...
        self.new_proxy_min_frame_size = QtGui.QSlider(self.new_proxy_tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.new_proxy_min_frame_size.sizePolicy().hasHeightForWidth())
        self.new_proxy_min_frame_size.setSizePolicy(sizePolicy)
        self.new_proxy_min_frame_size.setMinimumSize(QtCore.QSize(100, 0))
        self.new_proxy_min_frame_size.setMinimum(24)
        self.new_proxy_min_frame_size.setMaximum(8192)
        self.new_proxy_min_frame_size.setSingleStep(4)
        self.new_proxy_min_frame_size.setPageStep(400)
        self.new_proxy_min_frame_size.setOrientation(QtCore.Qt.Horizontal)
        self.new_proxy_min_frame_size.setTickPosition(QtGui.QSlider.TicksBelow)
        self.new_proxy_min_frame_size.setTickInterval(400)
        self.new_proxy_min_frame_size.setObjectName("new_proxy_min_frame_size")
        self.horizontalLayout_8.addWidget(self.new_proxy_min_frame_size)
        self.new_proxy_min_frame_size_preview = QtGui.QLabel(self.new_proxy_tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.new_proxy_min_frame_size_preview.sizePolicy().hasHeightForWidth())
        self.new_proxy_min_frame_size_preview.setSizePolicy(sizePolicy)
        self.new_proxy_min_frame_size_preview.setObjectName("new_proxy_min_frame_size_preview")
        self.horizontalLayout_8.addWidget(self.new_proxy_min_frame_size_preview)
